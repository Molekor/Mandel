...
public class MainWindow extends JFrame implements ItemListener, ActionListener {
	...
	private class KaestchenListener extends MouseAdapter implements MouseMotionListener {
		...
		public void mouseDragged(MouseEvent event) {
			mx2 = event.getX();
			MainWindow.this.actionProcessor.selectingArea(new Rectangle(mx1, my1, Math.abs(mx2 - mx1), (int) ((double) MainWindow.this.pictureArea.getHeight()
					* (double) (Math.abs(mx2 - mx1) / (double) MainWindow.this.pictureArea.getWidth()))));
		}
